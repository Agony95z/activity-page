...
import CfdPhone from "./cfd-phone.vue";
        ...
        <div class="feature_content">
          <div class="flex">
            <div class="flex-1 flex flex-col item relative pt-[40px] pl-[80px] pr-[30px] pb-[28px]" v-for="item in featureArr.slice(0, 2)" :key="item.id">
              ...
              <p class="text-[#666] pr-[80px] border-box text-[15px] mt-2.5">{{ item.content }}</p>
              <p class="text-[#666] pr-[80px] border-box text-[15px] mt-2.5">{{ item.content2 }}</p>
              <p class="text-[#666] pr-[80px] border-box text-[15px] mt-2.5">{{ item.content3 }}</p>
        ...
        <div ref="son" class="over_container" :style="{ transform: transformStyle }">
          <div class="flex">
            <div class="time_text" v-for="(item, index) in timeArr" :key="item.id" @click="handleYear(index)">
              <div class="time_year">
                <div class="px-2.5 text-[#999]" :class="{'active': item?.active}">{{item.text1}}</div>
              </div>
              <div class="line">
                <div class="dot" :class="{'active': item?.active}"></div>
              </div>
              <div class="time_detail">
                <div class="px-2.5 text-[#999]" :class="{'active': item?.active}">{{item.text2}}</div>
                <div v-if="item.text3" class="px-2.5 text-[#999]" :class="{'active': item?.active}">{{item.text3}}</div>
              </div>
            </div>
          </div>
        </div>
