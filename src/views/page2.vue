          ...
          <div class="flex">
            <div class="time_text" v-for="(item, index) in timeArr" :key="item.id" @click="handleYear(index)">
              ...
              <div class="time_detail">
                ...
                <div v-if="item.text3" class="text-[14px]" style="padding: 0 10px;" :class="{'active': item?.active}">{{item.text3}}</div>
                <div v-if="item.text4" class="text-[14px]" style="padding: 0 10px;" :class="{'active': item?.active}">{{item.text4}}</div>
              </div>
            </div>
          </div>
        </div>
