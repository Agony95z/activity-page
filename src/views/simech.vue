...
import SimechPhone from "./simech-phone.vue";
    ...
    <div class="introduce">
      <div style="position: relative; height: 370px;">
        <div class="introduce_center">
          <div class="top_text">
            <div class="text_1">About SiMech</div>
            <div class="text_2">SiMech简介</div>
          </div>
          <div class="content">
            <div class="con_l">
...
<!--    <div class="cfd_wrapper">
  ...
  <div class="block md:hidden">
    <simech-phone :feature-arr="featureArr" :cfd-arr="cfdArr" :swiper-arr="softArr"></simech-phone>
  </div>
</template>
